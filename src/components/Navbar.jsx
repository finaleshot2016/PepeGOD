      ...
      <div className='bg-[#85ce56] bg-opacity-0 max-w-auto mx-auto flex justify-between items-center h-full'>
        ...
        <div className='hidden md:flex'>
          <ul className='flex text-[#276400] items-center'>
            ...
            <li><a href="https://medium.com/@PepeFrog" target="_blank" rel="noopener noreferrer">MEDIUM</a></li>
            <li><a href="mailto:godofmemespepe2022@gmail.com" target="_blank" rel="noopener noreferrer">CONTACT US</a></li>
            <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-2 mt-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><a href="https://app.uniswap.org/#/swap?outputCurrency=0x4c57dFF92DB3cBB7071E8159960A3b2c488d33C7" target="_blank" rel="noopener noreferrer">BUY NOW!</a></button>
          </ul>
        </div>
